...
class _SettingsScreenState extends State<SettingsScreen> {
      ...
      builder: (context, themeService, child) => _buildSectionCard(
        ...
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text(
              'Choose color for AI responses (light & dark options)',
            ),
            trailing: Container(
              width: 32,
              height: 32,
  ...
  void _showBubbleColorPicker(ThemeService themeService, bool isUserBubble) {
    final currentColor = isUserBubble
        ? themeService.userBubbleColor
        : themeService.aiBubbleColor;
    final title = isUserBubble
        ? 'Choose User Message Color'
        : 'Choose AI Message Color';
